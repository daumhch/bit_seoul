...
modelpath = './model/hcbae22_rnn_{epoch:02d}_{val_loss:.4f}.hdf5'
model_save_path = "./save/hcbae22_rnn_model.h5"
weights_save_path = './save/hcbae22_rnn_weights.h5'
...
modelpath = './save/hcbae22_rnn_689_1625269.3750.hdf5'
