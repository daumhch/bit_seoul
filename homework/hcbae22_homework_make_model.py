...
def custom_model(model):
    temp = Conv1D(64, 9, padding='same', strides=1, activation='relu')(model)
    temp = Conv1D(64, 1, padding='same', strides=1, activation='relu')(temp)
    temp = MaxPooling1D(pool_size=2, padding='same', strides=2)(temp)
    temp = Dropout(0.2)(temp)
    temp = Conv1D(128, 9, padding='same', strides=1, activation='relu')(temp)
    temp = Conv1D(128, 1, padding='same', strides=1, activation='relu')(temp)
    temp = MaxPooling1D(pool_size=2, padding='same', strides=2)(temp)
    temp = Dropout(0.3)(temp)
    temp = Conv1D(256, 9, padding='same', strides=1, activation='relu')(temp)
    temp = Conv1D(128, 1, padding='same', strides=1, activation='relu')(temp)
    temp = MaxPooling1D(pool_size=2, padding='same', strides=2)(temp)
