...
# 1.4 reshape
# 이미 4차원이라 reshape이 필요가 없다



modelpath = './model/keras61_4_{epoch:02d}_{val_loss:.4f}.hdf5'
model_save_path = "./save/keras61_4_cifar100_model.h5"
weights_save_path = './save/keras61_4_cifar100_weights.h5'
