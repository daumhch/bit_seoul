...
modelpath = './model/keras61_5_{epoch:02d}_{val_loss:.4f}.hdf5'
model_save_path = "./save/keras61_5_boston_model.h5"
weights_save_path = './save/keras61_5_boston_weights.h5'
