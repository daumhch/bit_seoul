...
modelpath = './model/keras61_6_{epoch:02d}_{val_loss:.4f}.hdf5'
model_save_path = "./save/keras61_6_diabetes_model.h5"
weights_save_path = './save/keras61_6_diabetes_weights.h5'
