...
# ======== 데이터 불러오기 시작 ========
indexes = np.load('./1st_project/csv_index.npy', allow_pickle=True)
x = np.load('./1st_project/merge_data.npy', allow_pickle=True)
y = np.load('./1st_project/merge_target.npy', allow_pickle=True)
# print(x[0])
