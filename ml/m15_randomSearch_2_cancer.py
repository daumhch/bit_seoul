...
model = RandomizedSearchCV(RandomForestClassifier(), parameters, cv=kfold, verbose=1) # kfold가 5번 x 20번 = 총 100번
...
# RandomizedSearchCV
# 최적의 매개변수: RandomForestClassifier(max_depth=12, min_samples_leaf=3, min_samples_split=6,
#                        n_estimators=400, n_jobs=-1)
# 최적의 파라미터: {'n_jobs': -1, 'n_estimators': 400, 'min_samples_split': 6, 'min_samples_leaf': 3, 'max_depth': 12} 
# 최종정답률: 0.9649122807017544
