...
print("교차 검증 분할 (접기 / 반복) 수:", model.n_splits_)
...
# 최적의 파라미터: {'max_depth': 12, 'min_samples_leaf': 3, 'min_samples_split': 2, 'n_estimators': 100, 'n_jobs': -1}
...
#                        n_jobs=-1)      
# 최적의 파라미터: {'n_jobs': -1, 'n_estimators': 100, 'min_samples_split': 5, 'min_samples_leaf': 5, 'max_depth': 8}  
# 교차 검증 분할 (접기 / 반복) 수: 5     
# 최종정답률: 0.9722222222222222
...
#                        n_jobs=-1)      
# 최적의 파라미터: {'n_jobs': -1, 'n_estimators': 100, 'min_samples_split': 3, 'min_samples_leaf': 5, 'max_depth': 10} 
# 최종정답률: 0.9722222222222222

# RandomizedSearchCV n_iter=100
# 최적의 매개변수: RandomForestClassifier(max_depth=8, min_samples_leaf=7, min_samples_split=10,
#                        n_jobs=-1)      
