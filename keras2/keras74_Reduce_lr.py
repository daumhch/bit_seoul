...
modelpath = './model/keras74_{epoch:02d}_{val_loss:.4f}.hdf5'
...
# early_stoppping이 6회라면,
# reduce 3회라면,
# reduce 3회 하고, factor로 줄이고
# 또 3회 하고나면 멈춘다 -> early_stopping
reduce_lr = ReduceLROnPlateau(
    monitor='val_loss',
    patience=3, # 3번의 개선이 없으면
    factor=0.5, # lr을 0.5 곱한다
    verbose=1)
